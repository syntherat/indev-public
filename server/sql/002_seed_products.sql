INSERT INTO products (
  slug, name, category, description, detail, bullets, stat_label, stat_value,
  accent, is_featured, price, period, image, image_alt, href, display_order
) VALUES
  (
    'commerce-os',
    'Commerce OS',
    ...
    ARRAY['Unified inventory view', 'Order health timeline', 'Automated stock alerts'],
    'Processing time',
    '-34%',
  ...
  (
    ...
    ARRAY['Offline-safe actions', 'Smart visit checklists', 'Instant status sync'],
    'Task completion',
    '+27%',
  ...
  (
    ...
    ARRAY['Role-based analytics', 'Live KPI boards', 'Cross-team drilldowns'],
    'Decision cycle',
    '-41%',
    'product-accent-cyan',
    true,
  ...
  (
    ...
    ARRAY['Modular architecture', 'Custom workflow engine', 'Future-ready scaling'],
    'Delivery velocity',
    '+2.1x',
    'product-accent-rose',
    false,
